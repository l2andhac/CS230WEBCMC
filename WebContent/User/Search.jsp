...
function validateForm(){
	...
	var expensesUp = parseFloat(document.forms["Search"]["ExpensesUp"].value);
	var finAidLo = parseFloat(document.forms["Search"]["FinancialAidDown"].value);
	var finAidUp = parseFloat(document.forms["Search"]["FinancialAidUp"].value);
	var appLo = parseInt(document.forms["Search"]["ApplicantsDown"].value);
	var appUp = parseInt(document.forms["Search"]["ApplicantsUp"].value);
	var admLo = parseFloat(document.forms["Search"]["AdmittedDown"].value);
	var admUp = parseFloat(document.forms["Search"]["AdmittedUp"].value);
	var enrolLo = parseFloat(document.forms["Search"]["EnrolledDown"].value);
	var enrolUp = parseFloat(document.forms["Search"]["EnrolledUp"].value);
